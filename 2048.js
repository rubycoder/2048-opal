...
(function(Opal) {
  ...
  (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Board_initialize_1, TMP_Board_fill_cell_2, TMP_Board_unfill_cell_3, TMP_Board_canvas_id_4, TMP_Board_add_mouse_event_listener_7, TMP_Board_draw_canvas_8, TMP_Board_blank_state_11, TMP_Board_redraw_canvas_13, TMP_Board_get_cursor_position_14, TMP_Board_add_demo_event_listener_17, TMP_Board_ctrl_b_pressed$q_18, TMP_Board_add_enter_event_listener_21, TMP_Board_enter_pressed$q_22, TMP_Board_run_24, TMP_Board_tick_25, TMP_Board_new_state_27, TMP_Board_get_state_at_28, TMP_Board_is_underpopulated$q_29, TMP_Board_is_living_happily$q_30, TMP_Board_is_overpopulated$q_31, TMP_Board_can_reproduce$q_32, TMP_Board_population_at_33, TMP_Board_is_alive$q_34, TMP_Board_is_dead$q_35;
    ...
    }, TMP_Board_fill_cell_2.$$arity = 2);
    
    Opal.defn(self, '$unfill_cell', TMP_Board_unfill_cell_3 = function $$unfill_cell(x, y) {
      var self = this;
    ...
    }, TMP_Board_unfill_cell_3.$$arity = 2);
    
    Opal.defn(self, '$canvas_id', TMP_Board_canvas_id_4 = function $$canvas_id() {
      var self = this;

      return "board"
    }, TMP_Board_canvas_id_4.$$arity = 0);
    
    Opal.defn(self, '$add_mouse_event_listener', TMP_Board_add_mouse_event_listener_7 = function $$add_mouse_event_listener() {
      var TMP_5, TMP_6, self = this;

      
      $send(Opal.const_get_relative($nesting, 'Element').$find("" + "#" + (self.$canvas_id())), 'on', ["click"], (TMP_5 = function(event){var self = TMP_5.$$s || this, $a, coords = nil, x = nil, y = nil;
if (event == null) event = nil;
      
        coords = self.$get_cursor_position(event);
        $a = [coords.$x(), coords.$y()], (x = $a[0]), (y = $a[1]), $a;
        self.$fill_cell(x, y);
        return self.$seed()['$<<']([x, y]);}, TMP_5.$$s = self, TMP_5.$$arity = 1, TMP_5));
      return $send(Opal.const_get_relative($nesting, 'Element').$find("" + "#" + (self.$canvas_id())), 'on', ["dblclick"], (TMP_6 = function(event){var self = TMP_6.$$s || this, $a, coords = nil, x = nil, y = nil;
if (event == null) event = nil;
      
        coords = self.$get_cursor_position(event);
        $a = [coords.$x(), coords.$y()], (x = $a[0]), (y = $a[1]), $a;
        self.$unfill_cell(x, y);
        return self.$seed().$delete([x, y]);}, TMP_6.$$s = self, TMP_6.$$arity = 1, TMP_6));
    }, TMP_Board_add_mouse_event_listener_7.$$arity = 0);
    
    Opal.defn(self, '$draw_canvas', TMP_Board_draw_canvas_8 = function $$draw_canvas() {
    ...
    }, TMP_Board_draw_canvas_8.$$arity = 0);
    
    Opal.defn(self, '$blank_state', TMP_Board_blank_state_11 = function $$blank_state() {
      var TMP_9, self = this, h = nil;

      
      h = $hash2([], {});
      $send(Opal.Range.$new(0, self.$max_x(), false), 'each', [], (TMP_9 = function(x){var self = TMP_9.$$s || this, TMP_10;
if (x == null) x = nil;
      return $send(Opal.Range.$new(0, self.$max_y(), false), 'each', [], (TMP_10 = function(y){var self = TMP_10.$$s || this, $writer = nil;
if (y == null) y = nil;
    ...
    Opal.defn(self, '$redraw_canvas', TMP_Board_redraw_canvas_13 = function $$redraw_canvas() {
      var TMP_12, self = this;

      
      self.$draw_canvas();
      return $send(self.$state(), 'each', [], (TMP_12 = function(cell, liveness){var self = TMP_12.$$s || this;
if (cell == null) cell = nil;if (liveness == null) liveness = nil;
    ...
    }, TMP_Board_redraw_canvas_13.$$arity = 0);
    
    Opal.defn(self, '$get_cursor_position', TMP_Board_get_cursor_position_14 = function $$get_cursor_position(event) {
    ...
    }, TMP_Board_get_cursor_position_14.$$arity = 1);
    
    Opal.defn(self, '$add_demo_event_listener', TMP_Board_add_demo_event_listener_17 = function $$add_demo_event_listener() {
      var TMP_15, self = this;

      return $send(Opal.const_get_relative($nesting, 'Document'), 'on', ["keypress"], (TMP_15 = function(event){var self = TMP_15.$$s || this, TMP_16;
if (event == null) event = nil;
      if ($truthy(self['$ctrl_b_pressed?'](event))) {
          return $send([[25, 1], [23, 2], [25, 2], [13, 3], [14, 3], [21, 3], [22, 3], [12, 4], [16, 4], [21, 4], [22, 4], [35, 4], [36, 4], [1, 5], [2, 5], [11, 5], [17, 5], [21, 5], [22, 5], [35, 5], [36, 5], [1, 6], [2, 6], [11, 6], [15, 6], [17, 6], [18, 6], [23, 6], [25, 6], [11, 7], [17, 7], [25, 7], [12, 8], [16, 8], [13, 9], [14, 9]], 'each', [], (TMP_16 = function(x, y){var self = TMP_16.$$s || this;
if (x == null) x = nil;if (y == null) y = nil;
          
            self.$fill_cell(x, y);
            return self.$seed()['$<<']([x, y]);}, TMP_16.$$s = self, TMP_16.$$arity = 2, TMP_16))
          } else {
          return nil
        }}, TMP_15.$$s = self, TMP_15.$$arity = 1, TMP_15))
    }, TMP_Board_add_demo_event_listener_17.$$arity = 0);
    
    Opal.defn(self, '$ctrl_b_pressed?', TMP_Board_ctrl_b_pressed$q_18 = function(event) {
      var $a, self = this;

      return (($a = event.$ctrl_key()['$=='](true)) ? event.$which()['$=='](2) : event.$ctrl_key()['$=='](true))
    }, TMP_Board_ctrl_b_pressed$q_18.$$arity = 1);
    
    Opal.defn(self, '$add_enter_event_listener', TMP_Board_add_enter_event_listener_21 = function $$add_enter_event_listener() {
      var TMP_19, self = this;

      return $send(Opal.const_get_relative($nesting, 'Document'), 'on', ["keypress"], (TMP_19 = function(event){var self = TMP_19.$$s || this, TMP_20;
if (event == null) event = nil;
      
        $send(self.$seed(), 'each', [], (TMP_20 = function(x, y){var self = TMP_20.$$s || this, $writer = nil;
if (x == null) x = nil;if (y == null) y = nil;
    ...
    }, TMP_Board_add_enter_event_listener_21.$$arity = 0);
    
    Opal.defn(self, '$enter_pressed?', TMP_Board_enter_pressed$q_22 = function(event) {
      var self = this;

      return event.$which()['$=='](13)
    }, TMP_Board_enter_pressed$q_22.$$arity = 1);
    
    Opal.defn(self, '$run', TMP_Board_run_24 = function $$run() {
      var TMP_23, self = this;

      return $send(Opal.const_get_relative($nesting, 'Interval'), 'new', [], (TMP_23 = function(){var self = TMP_23.$$s || this;

      return self.$tick()}, TMP_23.$$s = self, TMP_23.$$arity = 0, TMP_23))
    }, TMP_Board_run_24.$$arity = 0);
    
    Opal.defn(self, '$tick', TMP_Board_tick_25 = function $$tick() {
      var self = this, $writer = nil;
    ...
    }, TMP_Board_tick_25.$$arity = 0);
    
    Opal.defn(self, '$new_state', TMP_Board_new_state_27 = function $$new_state() {
      var TMP_26, self = this, new_state = nil;

      
      new_state = Opal.const_get_relative($nesting, 'Hash').$new();
      $send(self.$state(), 'each', [], (TMP_26 = function(cell, _){var self = TMP_26.$$s || this, $writer = nil;
if (cell == null) cell = nil;if (_ == null) _ = nil;
      
        $writer = [cell, self.$get_state_at(cell['$[]'](0), cell['$[]'](1))];
        $send(new_state, '[]=', Opal.to_a($writer));
        return $writer[$rb_minus($writer["length"], 1)];}, TMP_26.$$s = self, TMP_26.$$arity = 2, TMP_26));
      return new_state;
    }, TMP_Board_new_state_27.$$arity = 0);
    
    Opal.defn(self, '$get_state_at', TMP_Board_get_state_at_28 = function $$get_state_at(x, y) {
      var self = this;
    ...
    }, TMP_Board_get_state_at_28.$$arity = 2);
    
    Opal.defn(self, '$is_underpopulated?', TMP_Board_is_underpopulated$q_29 = function(x, y) {
      var $a, self = this;

      return ($truthy($a = self['$is_alive?'](x, y)) ? $rb_lt(self.$population_at(x, y), 2) : $a)
    }, TMP_Board_is_underpopulated$q_29.$$arity = 2);
    
    Opal.defn(self, '$is_living_happily?', TMP_Board_is_living_happily$q_30 = function(x, y) {
      var $a, self = this;

      return ($truthy($a = self['$is_alive?'](x, y)) ? [2, 3]['$include?'](self.$population_at(x, y)) : $a)
    }, TMP_Board_is_living_happily$q_30.$$arity = 2);
    
    Opal.defn(self, '$is_overpopulated?', TMP_Board_is_overpopulated$q_31 = function(x, y) {
      var $a, self = this;

      return ($truthy($a = self['$is_alive?'](x, y)) ? $rb_gt(self.$population_at(x, y), 3) : $a)
    }, TMP_Board_is_overpopulated$q_31.$$arity = 2);
    
    Opal.defn(self, '$can_reproduce?', TMP_Board_can_reproduce$q_32 = function(x, y) {
      var $a, self = this;

      return ($truthy($a = self['$is_dead?'](x, y)) ? self.$population_at(x, y)['$=='](3) : $a)
    }, TMP_Board_can_reproduce$q_32.$$arity = 2);
    
    Opal.defn(self, '$population_at', TMP_Board_population_at_33 = function $$population_at(x, y) {
      var self = this;
    ...
    }, TMP_Board_population_at_33.$$arity = 2);
    
    Opal.defn(self, '$is_alive?', TMP_Board_is_alive$q_34 = function(x, y) {
      var self = this;

      return self.$state()['$[]']([x, y])['$=='](1)
    }, TMP_Board_is_alive$q_34.$$arity = 2);
    return (Opal.defn(self, '$is_dead?', TMP_Board_is_dead$q_35 = function(x, y) {
      var self = this;

      return self['$is_alive?'](x, y)['$!']()
    }, TMP_Board_is_dead$q_35.$$arity = 2), nil) && 'is_dead?';
  })($nesting[0], null, $nesting);
  (function($base, $super, $parent_nesting) {
