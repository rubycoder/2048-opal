...
(function(Opal) {
  ...
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $send = Opal.send, $truthy = Opal.truthy, $hash2 = Opal.hash2, board = nil, tile = nil;

  Opal.add_stubs(['$require', '$attr_reader', '$attr_accessor', '$canvas_id', '$canvas', '$floor', '$/', '$height', '$width', '$blank_state', '$*', '$min', '$draw_canvas', '$add_mouse_event_listener', '$add_demo_event_listener', '$add_enter_event_listener', '$context', '$x', '$y', '$+', '$-', '$on', '$find', '$get_cursor_position', '$fill_cell', '$<<', '$seed', '$unfill_cell', '$delete', '$>=', '$each', '$max_x', '$max_y', '$[]=', '$state', '$==', '$[]', '$page_x', '$page_y', '$Document', '$scrollLeft', '$documentElement', '$scrollTop', '$body', '$new', '$ctrl_b_pressed?', '$ctrl_key', '$which', '$enter_pressed?', '$run', '$tick', '$new_state', '$state=', '$redraw_canvas', '$get_state_at', '$is_underpopulated?', '$is_living_happily?', '$is_overpopulated?', '$can_reproduce?', '$is_alive?', '$<', '$population_at', '$include?', '$>', '$is_dead?', '$reduce', '$map', '$to_proc', '$!', '$draw_tile']);
  ...
  (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Board_initialize_1, TMP_Board_draw_tileOLD_2, TMP_Board_draw_tile_3, TMP_Board_fill_cell_4, TMP_Board_unfill_cell_5, TMP_Board_canvas_id_6, TMP_Board_add_mouse_event_listener_9, TMP_Board_draw_canvas_10, TMP_Board_blank_state_13, TMP_Board_redraw_canvas_15, TMP_Board_get_cursor_position_16, TMP_Board_add_demo_event_listener_19, TMP_Board_ctrl_b_pressed$q_20, TMP_Board_add_enter_event_listener_23, TMP_Board_enter_pressed$q_24, TMP_Board_run_26, TMP_Board_tick_27, TMP_Board_new_state_29, TMP_Board_get_state_at_30, TMP_Board_is_underpopulated$q_31, TMP_Board_is_living_happily$q_32, TMP_Board_is_overpopulated$q_33, TMP_Board_can_reproduce$q_34, TMP_Board_population_at_35, TMP_Board_is_alive$q_36, TMP_Board_is_dead$q_37;
    ...
    Opal.defn(self, '$fill_cell', TMP_Board_fill_cell_4 = function $$fill_cell(x, y) {
      var self = this;
    ...
    }, TMP_Board_fill_cell_4.$$arity = 2);
    
    Opal.defn(self, '$unfill_cell', TMP_Board_unfill_cell_5 = function $$unfill_cell(x, y) {
      var self = this;
    ...
    }, TMP_Board_unfill_cell_5.$$arity = 2);
    
    Opal.defn(self, '$canvas_id', TMP_Board_canvas_id_6 = function $$canvas_id() {
      var self = this;

      return "board"
    }, TMP_Board_canvas_id_6.$$arity = 0);
    
    Opal.defn(self, '$add_mouse_event_listener', TMP_Board_add_mouse_event_listener_9 = function $$add_mouse_event_listener() {
      var TMP_7, TMP_8, self = this;

      
      $send(Opal.const_get_relative($nesting, 'Element').$find("" + "#" + (self.$canvas_id())), 'on', ["click"], (TMP_7 = function(event){var self = TMP_7.$$s || this, $a, coords = nil, x = nil, y = nil;
if (event == null) event = nil;
      
        coords = self.$get_cursor_position(event);
        $a = [coords.$x(), coords.$y()], (x = $a[0]), (y = $a[1]), $a;
        self.$fill_cell(x, y);
        return self.$seed()['$<<']([x, y]);}, TMP_7.$$s = self, TMP_7.$$arity = 1, TMP_7));
      return $send(Opal.const_get_relative($nesting, 'Element').$find("" + "#" + (self.$canvas_id())), 'on', ["dblclick"], (TMP_8 = function(event){var self = TMP_8.$$s || this, $a, coords = nil, x = nil, y = nil;
if (event == null) event = nil;
      
        coords = self.$get_cursor_position(event);
        $a = [coords.$x(), coords.$y()], (x = $a[0]), (y = $a[1]), $a;
        self.$unfill_cell(x, y);
        return self.$seed().$delete([x, y]);}, TMP_8.$$s = self, TMP_8.$$arity = 1, TMP_8));
    }, TMP_Board_add_mouse_event_listener_9.$$arity = 0);
    
    Opal.defn(self, '$draw_canvas', TMP_Board_draw_canvas_10 = function $$draw_canvas() {
      ...
      self.$context().strokeStyle = "#eee";
      return self.$context().stroke();
    }, TMP_Board_draw_canvas_10.$$arity = 0);
    
    Opal.defn(self, '$blank_state', TMP_Board_blank_state_13 = function $$blank_state() {
      var TMP_11, self = this, h = nil;

      
      h = $hash2([], {});
      $send(Opal.Range.$new(0, self.$max_x(), false), 'each', [], (TMP_11 = function(x){var self = TMP_11.$$s || this, TMP_12;
if (x == null) x = nil;
      return $send(Opal.Range.$new(0, self.$max_y(), false), 'each', [], (TMP_12 = function(y){var self = TMP_12.$$s || this, $writer = nil;
if (y == null) y = nil;
        
          $writer = [[x, y], 0];
          $send(h, '[]=', Opal.to_a($writer));
          return $writer[$rb_minus($writer["length"], 1)];}, TMP_12.$$s = self, TMP_12.$$arity = 1, TMP_12))}, TMP_11.$$s = self, TMP_11.$$arity = 1, TMP_11));
      return h;
    }, TMP_Board_blank_state_13.$$arity = 0);
    
    Opal.defn(self, '$redraw_canvas', TMP_Board_redraw_canvas_15 = function $$redraw_canvas() {
      var TMP_14, self = this;

      
      self.$draw_canvas();
      return $send(self.$state(), 'each', [], (TMP_14 = function(cell, liveness){var self = TMP_14.$$s || this;
if (cell == null) cell = nil;if (liveness == null) liveness = nil;
    ...
    }, TMP_Board_redraw_canvas_15.$$arity = 0);
    
    Opal.defn(self, '$get_cursor_position', TMP_Board_get_cursor_position_16 = function $$get_cursor_position(event) {
    ...
    }, TMP_Board_get_cursor_position_16.$$arity = 1);
    
    Opal.defn(self, '$add_demo_event_listener', TMP_Board_add_demo_event_listener_19 = function $$add_demo_event_listener() {
      var TMP_17, self = this;

      return $send(Opal.const_get_relative($nesting, 'Document'), 'on', ["keypress"], (TMP_17 = function(event){var self = TMP_17.$$s || this, TMP_18;
if (event == null) event = nil;
      if ($truthy(self['$ctrl_b_pressed?'](event))) {
          return $send([[25, 1], [23, 2], [25, 2], [13, 3], [14, 3], [21, 3], [22, 3], [12, 4], [16, 4], [21, 4], [22, 4], [35, 4], [36, 4], [1, 5], [2, 5], [11, 5], [17, 5], [21, 5], [22, 5], [35, 5], [36, 5], [1, 6], [2, 6], [11, 6], [15, 6], [17, 6], [18, 6], [23, 6], [25, 6], [11, 7], [17, 7], [25, 7], [12, 8], [16, 8], [13, 9], [14, 9]], 'each', [], (TMP_18 = function(x, y){var self = TMP_18.$$s || this;
if (x == null) x = nil;if (y == null) y = nil;
          
            self.$fill_cell(x, y);
            return self.$seed()['$<<']([x, y]);}, TMP_18.$$s = self, TMP_18.$$arity = 2, TMP_18))
          } else {
          return nil
        }}, TMP_17.$$s = self, TMP_17.$$arity = 1, TMP_17))
    }, TMP_Board_add_demo_event_listener_19.$$arity = 0);
    
    Opal.defn(self, '$ctrl_b_pressed?', TMP_Board_ctrl_b_pressed$q_20 = function(event) {
      var $a, self = this;

      return (($a = event.$ctrl_key()['$=='](true)) ? event.$which()['$=='](2) : event.$ctrl_key()['$=='](true))
    }, TMP_Board_ctrl_b_pressed$q_20.$$arity = 1);
    
    Opal.defn(self, '$add_enter_event_listener', TMP_Board_add_enter_event_listener_23 = function $$add_enter_event_listener() {
      var TMP_21, self = this;

      return $send(Opal.const_get_relative($nesting, 'Document'), 'on', ["keypress"], (TMP_21 = function(event){var self = TMP_21.$$s || this, TMP_22;
if (event == null) event = nil;
      
        $send(self.$seed(), 'each', [], (TMP_22 = function(x, y){var self = TMP_22.$$s || this, $writer = nil;
if (x == null) x = nil;if (y == null) y = nil;
        
          $writer = [[x, y], 1];
          $send(self.$state(), '[]=', Opal.to_a($writer));
          return $writer[$rb_minus($writer["length"], 1)];}, TMP_22.$$s = self, TMP_22.$$arity = 2, TMP_22));
        if ($truthy(self['$enter_pressed?'](event))) {
          return self.$run()
          } else {
          return nil
        };}, TMP_21.$$s = self, TMP_21.$$arity = 1, TMP_21))
    }, TMP_Board_add_enter_event_listener_23.$$arity = 0);
    
    Opal.defn(self, '$enter_pressed?', TMP_Board_enter_pressed$q_24 = function(event) {
      var self = this;

      return event.$which()['$=='](13)
    }, TMP_Board_enter_pressed$q_24.$$arity = 1);
    
    Opal.defn(self, '$run', TMP_Board_run_26 = function $$run() {
      var TMP_25, self = this;

      return $send(Opal.const_get_relative($nesting, 'Interval'), 'new', [], (TMP_25 = function(){var self = TMP_25.$$s || this;

      return self.$tick()}, TMP_25.$$s = self, TMP_25.$$arity = 0, TMP_25))
    }, TMP_Board_run_26.$$arity = 0);
    
    Opal.defn(self, '$tick', TMP_Board_tick_27 = function $$tick() {
      var self = this, $writer = nil;
    ...
    }, TMP_Board_tick_27.$$arity = 0);
    
    Opal.defn(self, '$new_state', TMP_Board_new_state_29 = function $$new_state() {
      var TMP_28, self = this, new_state = nil;

      
      new_state = Opal.const_get_relative($nesting, 'Hash').$new();
      $send(self.$state(), 'each', [], (TMP_28 = function(cell, _){var self = TMP_28.$$s || this, $writer = nil;
if (cell == null) cell = nil;if (_ == null) _ = nil;
      ...
      return new_state;
    }, TMP_Board_new_state_29.$$arity = 0);
    
    Opal.defn(self, '$get_state_at', TMP_Board_get_state_at_30 = function $$get_state_at(x, y) {
      var self = this;
    ...
    }, TMP_Board_get_state_at_30.$$arity = 2);
    
    Opal.defn(self, '$is_underpopulated?', TMP_Board_is_underpopulated$q_31 = function(x, y) {
      var $a, self = this;

      return ($truthy($a = self['$is_alive?'](x, y)) ? $rb_lt(self.$population_at(x, y), 2) : $a)
    }, TMP_Board_is_underpopulated$q_31.$$arity = 2);
    
    Opal.defn(self, '$is_living_happily?', TMP_Board_is_living_happily$q_32 = function(x, y) {
      var $a, self = this;

      return ($truthy($a = self['$is_alive?'](x, y)) ? [2, 3]['$include?'](self.$population_at(x, y)) : $a)
    }, TMP_Board_is_living_happily$q_32.$$arity = 2);
    
    Opal.defn(self, '$is_overpopulated?', TMP_Board_is_overpopulated$q_33 = function(x, y) {
      var $a, self = this;

      return ($truthy($a = self['$is_alive?'](x, y)) ? $rb_gt(self.$population_at(x, y), 3) : $a)
    }, TMP_Board_is_overpopulated$q_33.$$arity = 2);
    
    Opal.defn(self, '$can_reproduce?', TMP_Board_can_reproduce$q_34 = function(x, y) {
      var $a, self = this;

      return ($truthy($a = self['$is_dead?'](x, y)) ? self.$population_at(x, y)['$=='](3) : $a)
    }, TMP_Board_can_reproduce$q_34.$$arity = 2);
    
    Opal.defn(self, '$population_at', TMP_Board_population_at_35 = function $$population_at(x, y) {
      var self = this;
    ...
    }, TMP_Board_population_at_35.$$arity = 2);
    
    Opal.defn(self, '$is_alive?', TMP_Board_is_alive$q_36 = function(x, y) {
      var self = this;

      return self.$state()['$[]']([x, y])['$=='](1)
    }, TMP_Board_is_alive$q_36.$$arity = 2);
    return (Opal.defn(self, '$is_dead?', TMP_Board_is_dead$q_37 = function(x, y) {
      var self = this;

      return self['$is_alive?'](x, y)['$!']()
    }, TMP_Board_is_dead$q_37.$$arity = 2), nil) && 'is_dead?';
  })($nesting[0], null, $nesting);
  (function($base, $super, $parent_nesting) {
