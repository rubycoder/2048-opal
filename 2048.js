...
Opal.modules["tile"] = function(Opal) {
  ...
  return (function($base, $super) {
    ...
    return (Opal.defn(self, '$initialize', function(x, y) {
      var self = this;
...
Opal.modules["interval"] = function(Opal) {
  ...
  return (function($base, $super) {
    ...
    def.interval = nil;
    Opal.defn(self, '$initialize', TMP_1 = function(time) {
      var self = this, $iter = TMP_1.$$p, block = $iter || nil;
...
(function(Opal) {
  ...
  var self = Opal.top, $scope = Opal, nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $hash2 = Opal.hash2, $range = Opal.range, board = nil, tile = nil;

  Opal.add_stubs(['$require', '$attr_reader', '$attr_accessor', '$canvas_id', '$canvas', '$floor', '$/', '$height', '$width', '$blank_state', '$*', '$min', '$draw_canvas', '$add_mouse_event_listener', '$add_demo_event_listener', '$add_enter_event_listener', '$context', '$x', '$y', '$+', '$-', '$on', '$get_cursor_position', '$fill_cell', '$<<', '$seed', '$find', '$unfill_cell', '$delete', '$>=', '$each', '$[]=', '$max_y', '$max_x', '$==', '$[]', '$state', '$page_x', '$page_y', '$Document', '$scrollLeft', '$documentElement', '$scrollTop', '$body', '$new', '$ctrl_b_pressed?', '$ctrl_key', '$which', '$enter_pressed?', '$run', '$tick', '$state=', '$new_state', '$redraw_canvas', '$get_state_at', '$is_underpopulated?', '$is_living_happily?', '$is_overpopulated?', '$can_reproduce?', '$is_alive?', '$<', '$population_at', '$include?', '$>', '$is_dead?', '$reduce', '$map', '$to_proc', '$!', '$draw_tile']);
  self.$require("opal");
  ...
  (function($base, $super) {
    ...
    Opal.cdecl($scope, 'COLUMNS', 4);

    Opal.cdecl($scope, 'ROWS', 4);

    Opal.cdecl($scope, 'SQUARE_EDGE', 40);

    Opal.cdecl($scope, 'BORDER_SIZE', 5);
    ...
    Opal.defn(self, '$initialize', function() {
      ...
      self.seed = [];
      self.tiles = [];
      tile_max_height = ($rb_divide($rb_times(0.9, self.height), $scope.get('ROWS'))).$floor();
      tile_max_width = ($rb_divide($rb_times(0.9, self.width), $scope.get('COLUMNS'))).$floor();
    ...
    Opal.defn(self, '$draw_tileOLD', function(tile) {
      var self = this;
    ...
    Opal.defn(self, '$draw_tile', function(tile) {
      var self = this;
    ...
    Opal.defn(self, '$add_mouse_event_listener', function() {
      ...
      ($a = ($b = $scope.get('Element').$find("#" + (self.$canvas_id()))).$on, $a.$$p = (TMP_1 = function(event){var self = TMP_1.$$s || this, $a, coords = nil, x = nil, y = nil;
if (event == null) event = nil;
      coords = self.$get_cursor_position(event);
        $a = [coords.$x(), coords.$y()], x = $a[0], y = $a[1], $a;
        self.$fill_cell(x, y);
        return self.$seed()['$<<']([x, y]);}, TMP_1.$$s = self, TMP_1), $a).call($b, "click");
      return ($a = ($c = $scope.get('Element').$find("#" + (self.$canvas_id()))).$on, $a.$$p = (TMP_2 = function(event){var self = TMP_2.$$s || this, $a, coords = nil, x = nil, y = nil;
if (event == null) event = nil;
      coords = self.$get_cursor_position(event);
        $a = [coords.$x(), coords.$y()], x = $a[0], y = $a[1], $a;
        self.$unfill_cell(x, y);
        return self.$seed().$delete([x, y]);}, TMP_2.$$s = self, TMP_2), $a).call($c, "dblclick");
    });
    ...
    Opal.defn(self, '$blank_state', function() {
      var $a, $b, TMP_3, self = this, h = nil;

      h = $hash2([], {});
      ($a = ($b = ($range(0, self.$max_x(), false))).$each, $a.$$p = (TMP_3 = function(x){var self = TMP_3.$$s || this, $a, $b, TMP_4;
if (x == null) x = nil;
      return ($a = ($b = ($range(0, self.$max_y(), false))).$each, $a.$$p = (TMP_4 = function(y){var self = TMP_4.$$s || this;
if (y == null) y = nil;
        return h['$[]=']([x, y], 0)}, TMP_4.$$s = self, TMP_4), $a).call($b)}, TMP_3.$$s = self, TMP_3), $a).call($b);
      return h;
    });

    Opal.defn(self, '$redraw_canvas', function() {
      var $a, $b, TMP_5, self = this;

      self.$draw_canvas();
      return ($a = ($b = self.$state()).$each, $a.$$p = (TMP_5 = function(cell, liveness){var self = TMP_5.$$s || this;
if (cell == null) cell = nil;if (liveness == null) liveness = nil;
    ...
    Opal.defn(self, '$add_demo_event_listener', function() {
      var $a, $b, TMP_6, self = this;

      return ($a = ($b = $scope.get('Document')).$on, $a.$$p = (TMP_6 = function(event){var self = TMP_6.$$s || this, $a, $b, TMP_7;
if (event == null) event = nil;
      if ((($a = self['$ctrl_b_pressed?'](event)) !== nil && (!$a.$$is_boolean || $a == true))) {
          return ($a = ($b = [[25, 1], [23, 2], [25, 2], [13, 3], [14, 3], [21, 3], [22, 3], [12, 4], [16, 4], [21, 4], [22, 4], [35, 4], [36, 4], [1, 5], [2, 5], [11, 5], [17, 5], [21, 5], [22, 5], [35, 5], [36, 5], [1, 6], [2, 6], [11, 6], [15, 6], [17, 6], [18, 6], [23, 6], [25, 6], [11, 7], [17, 7], [25, 7], [12, 8], [16, 8], [13, 9], [14, 9]]).$each, $a.$$p = (TMP_7 = function(x, y){var self = TMP_7.$$s || this;
if (x == null) x = nil;if (y == null) y = nil;
          self.$fill_cell(x, y);
            return self.$seed()['$<<']([x, y]);}, TMP_7.$$s = self, TMP_7), $a).call($b)
          } else {
          return nil
        }}, TMP_6.$$s = self, TMP_6), $a).call($b, "keypress");
    });

    Opal.defn(self, '$ctrl_b_pressed?', function(event) {
      var $a, self = this;

      return (($a = event.$ctrl_key()['$=='](true)) ? event.$which()['$=='](2) : event.$ctrl_key()['$=='](true));
    });

    Opal.defn(self, '$add_enter_event_listener', function() {
      var $a, $b, TMP_8, self = this;

      return ($a = ($b = $scope.get('Document')).$on, $a.$$p = (TMP_8 = function(event){var self = TMP_8.$$s || this, $a, $b, TMP_9;
if (event == null) event = nil;
      ($a = ($b = self.$seed()).$each, $a.$$p = (TMP_9 = function(x, y){var self = TMP_9.$$s || this;
if (x == null) x = nil;if (y == null) y = nil;
        return self.$state()['$[]=']([x, y], 1)}, TMP_9.$$s = self, TMP_9), $a).call($b);
        if ((($a = self['$enter_pressed?'](event)) !== nil && (!$a.$$is_boolean || $a == true))) {
          return self.$run()
          } else {
          return nil
        };}, TMP_8.$$s = self, TMP_8), $a).call($b, "keypress");
    });

    Opal.defn(self, '$enter_pressed?', function(event) {
      var self = this;
    ...
    Opal.defn(self, '$run', function() {
      ...
      return ($a = ($b = $scope.get('Interval')).$new, $a.$$p = (TMP_10 = function(){var self = TMP_10.$$s || this;

      return self.$tick()}, TMP_10.$$s = self, TMP_10), $a).call($b);
    });
    ...
    Opal.defn(self, '$new_state', function() {
      var $a, $b, TMP_11, self = this, new_state = nil;

      new_state = $scope.get('Hash').$new();
      ($a = ($b = self.$state()).$each, $a.$$p = (TMP_11 = function(cell, _){var self = TMP_11.$$s || this;
if (cell == null) cell = nil;if (_ == null) _ = nil;
      return new_state['$[]='](cell, self.$get_state_at(cell['$[]'](0), cell['$[]'](1)))}, TMP_11.$$s = self, TMP_11), $a).call($b);
      return new_state;
    });

    Opal.defn(self, '$get_state_at', function(x, y) {
      var $a, self = this;

      if ((($a = self['$is_underpopulated?'](x, y)) !== nil && (!$a.$$is_boolean || $a == true))) {
        return 0
      } else if ((($a = self['$is_living_happily?'](x, y)) !== nil && (!$a.$$is_boolean || $a == true))) {
        return 1
      } else if ((($a = self['$is_overpopulated?'](x, y)) !== nil && (!$a.$$is_boolean || $a == true))) {
        return 0
      } else if ((($a = self['$can_reproduce?'](x, y)) !== nil && (!$a.$$is_boolean || $a == true))) {
        return 1
        } else {
        return nil
      };
    ...
    Opal.defn(self, '$is_underpopulated?', function(x, y) {
      var $a, self = this;

      return ($a = self['$is_alive?'](x, y), $a !== false && $a !== nil ?$rb_lt(self.$population_at(x, y), 2) : $a);
    });

    Opal.defn(self, '$is_living_happily?', function(x, y) {
      var $a, self = this;

      return ($a = self['$is_alive?'](x, y), $a !== false && $a !== nil ?([2, 3]['$include?'](self.$population_at(x, y))) : $a);
    });

    Opal.defn(self, '$is_overpopulated?', function(x, y) {
      var $a, self = this;

      return ($a = self['$is_alive?'](x, y), $a !== false && $a !== nil ?$rb_gt(self.$population_at(x, y), 3) : $a);
    });

    Opal.defn(self, '$can_reproduce?', function(x, y) {
      var $a, self = this;

      return ($a = self['$is_dead?'](x, y), $a !== false && $a !== nil ?self.$population_at(x, y)['$=='](3) : $a);
    });

    Opal.defn(self, '$population_at', function(x, y) {
      var $a, $b, self = this;

      return ($a = ($b = [self.$state()['$[]']([$rb_minus(x, 1), $rb_minus(y, 1)]), self.$state()['$[]']([$rb_minus(x, 1), y]), self.$state()['$[]']([$rb_minus(x, 1), $rb_plus(y, 1)]), self.$state()['$[]']([x, $rb_minus(y, 1)]), self.$state()['$[]']([x, $rb_plus(y, 1)]), self.$state()['$[]']([$rb_plus(x, 1), $rb_minus(y, 1)]), self.$state()['$[]']([$rb_plus(x, 1), y]), self.$state()['$[]']([$rb_plus(x, 1), $rb_plus(y, 1)])]).$map, $a.$$p = "to_i".$to_proc(), $a).call($b).$reduce("+");
    });

    Opal.defn(self, '$is_alive?', function(x, y) {
      var self = this;

      return self.$state()['$[]']([x, y])['$=='](1);
    });

    return (Opal.defn(self, '$is_dead?', function(x, y) {
      var self = this;
  ...
  board = $scope.get('Board').$new();
  tile = $scope.get('Tile').$new(1, 1);
