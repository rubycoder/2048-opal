...
/* Generated by Opal 0.11.4 */
Opal.modules["tile"] = function(Opal) {
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass;
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Tile_initialize_1;

    
    self.$attr_accessor("x", "y");
    return (Opal.defn(self, '$initialize', TMP_Tile_initialize_1 = function $$initialize(x, y) {
      var self = this;

      
      self.x = x;
      return (self.y = y);
    }, TMP_Tile_initialize_1.$$arity = 2), nil) && 'initialize';
  })($nesting[0], null, $nesting)
};
...
Opal.modules["interval"] = function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Interval_initialize_1, TMP_Interval_stop_2;

    def.interval = nil;
    
    
    Opal.defn(self, '$initialize', TMP_Interval_initialize_1 = function $$initialize(time) {
    ...
    }, TMP_Interval_initialize_1.$$arity = -1);
    return (Opal.defn(self, '$stop', TMP_Interval_stop_2 = function $$stop() {
      var self = this;

      return clearInterval(self.interval)
    }, TMP_Interval_stop_2.$$arity = 0), nil) && 'stop';
  })($nesting[0], null, $nesting)
};
...
Opal.modules["canvas"] = function(Opal) {
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Canvas_initialize_1, TMP_Canvas_draw_rectangle_2;

    def.canvas = def.context = nil;
    
    
    Opal.defn(self, '$initialize', TMP_Canvas_initialize_1 = function $$initialize(canvas_id) {
      var self = this;

      
      self.canvas = document.getElementById(canvas_id);
      return (self.context = self.canvas.getContext('2d'));
    }, TMP_Canvas_initialize_1.$$arity = 1);
    return (Opal.defn(self, '$draw_rectangle', TMP_Canvas_draw_rectangle_2 = function $$draw_rectangle(left, top, width, height, fill_style, line_width, stroke_style) {
      var self = this;

      
      self.context.rect(left, top, width, height);
      self.context.fillStyle = fill_style;
      self.context.fill();
      self.context.lineWidth = line_width;
      self.context.strokeStyle = stroke_style;
      return self.context.stroke();
    }, TMP_Canvas_draw_rectangle_2.$$arity = 7), nil) && 'draw_rectangle';
  })($nesting[0], null, $nesting)
};
...
(function(Opal) {
  ...
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $klass = Opal.klass, $send = Opal.send, $truthy = Opal.truthy, $hash2 = Opal.hash2, board = nil, tile = nil, canvas = nil;

  Opal.add_stubs(['$require', '$attr_reader', '$attr_accessor', '$canvas_id', '$canvas', '$floor', '$/', '$height', '$width', '$blank_state', '$*', '$min', '$add_mouse_event_listener', '$add_demo_event_listener', '$add_enter_event_listener', '$context', '$x', '$y', '$+', '$-', '$on', '$find', '$get_cursor_position', '$fill_cell', '$<<', '$seed', '$unfill_cell', '$delete', '$>=', '$each', '$max_x', '$max_y', '$[]=', '$draw_grid', '$state', '$==', '$[]', '$page_x', '$page_y', '$Document', '$scrollLeft', '$documentElement', '$scrollTop', '$body', '$new', '$ctrl_b_pressed?', '$ctrl_key', '$which', '$enter_pressed?', '$run', '$tick', '$new_state', '$state=', '$get_state_at', '$is_underpopulated?', '$is_living_happily?', '$is_overpopulated?', '$can_reproduce?', '$is_alive?', '$<', '$population_at', '$include?', '$>', '$is_dead?', '$reduce', '$map', '$to_proc', '$!', '$draw_rectangle']);
  
  self.$require("opal");
  self.$require("opal-jquery");
  self.$require("forwardable");
  self.$require("ostruct");
  self.$require("2048"+ '/../' + "tile");
  self.$require("2048"+ '/../' + "interval");
  self.$require("2048"+ '/../' + "canvas");
  (function($base, $super, $parent_nesting) {
    function $Board(){};
    var self = $Board = $klass($base, $super, 'Board', $Board);

    var def = self.$$proto, $nesting = [self].concat($parent_nesting), TMP_Board_initialize_1, TMP_Board_draw_tileOLD_2, TMP_Board_draw_tile_3, TMP_Board_draw_tile2_4, TMP_Board_fill_cell_5, TMP_Board_unfill_cell_6, TMP_Board_canvas_id_7, TMP_Board_add_mouse_event_listener_10, TMP_Board_draw_grid_11, TMP_Board_blank_state_14, TMP_Board_redraw_grid_16, TMP_Board_get_cursor_position_17, TMP_Board_add_demo_event_listener_20, TMP_Board_ctrl_b_pressed$q_21, TMP_Board_add_enter_event_listener_24, TMP_Board_enter_pressed$q_25, TMP_Board_run_27, TMP_Board_tick_28, TMP_Board_new_state_30, TMP_Board_get_state_at_31, TMP_Board_is_underpopulated$q_32, TMP_Board_is_living_happily$q_33, TMP_Board_is_overpopulated$q_34, TMP_Board_can_reproduce$q_35, TMP_Board_population_at_36, TMP_Board_is_alive$q_37, TMP_Board_is_dead$q_38;

    def.height = def.width = def.tile_height = def.tile_width = nil;
    ...
    Opal.const_set($nesting[0], 'COLUMNS', 4);
    Opal.const_set($nesting[0], 'ROWS', 4);
    Opal.const_set($nesting[0], 'SQUARE_EDGE', 40);
    Opal.const_set($nesting[0], 'BORDER_SIZE', 5);
    
    Opal.defn(self, '$initialize', TMP_Board_initialize_1 = function $$initialize() {
      var self = this, tile_max_height = nil, tile_max_width = nil;
      ...
      self.seed = [];
      self.tiles = [];
      tile_max_height = $rb_divide($rb_times(0.9, self.height), Opal.const_get_relative($nesting, 'ROWS')).$floor();
      tile_max_width = $rb_divide($rb_times(0.9, self.width), Opal.const_get_relative($nesting, 'COLUMNS')).$floor();
      self.tile_height = [tile_max_height, tile_max_width].$min();
      self.tile_width = self.tile_height;
      self.$add_mouse_event_listener();
      self.$add_demo_event_listener();
      return self.$add_enter_event_listener();
    }, TMP_Board_initialize_1.$$arity = 0);
    
    Opal.defn(self, '$draw_tileOLD', TMP_Board_draw_tileOLD_2 = function $$draw_tileOLD(tile) {
      var self = this;

      
      self.$canvas().width  = self.$width();
      self.$canvas().height = self.$height();
      self.$context().moveTo($rb_times(tile.$x(), self.tile_width), $rb_times(tile.$y(), self.tile_height));
      self.$context().lineTo($rb_times($rb_plus(tile.$x(), 1), self.tile_width), $rb_times(tile.$y(), self.tile_height));
      self.$context().strokeStyle = "#eee";
      return self.$context().stroke();
    }, TMP_Board_draw_tileOLD_2.$$arity = 1);
    
    Opal.defn(self, '$draw_tile', TMP_Board_draw_tile_3 = function $$draw_tile(tile) {
      var self = this;

      
      self.$context().rect(400, 400,
                 200, 100);
      self.$context().rect(0, 0,
                 200, 100);
      ...
      return self.$context().stroke();
    }, TMP_Board_draw_tile_3.$$arity = 1);
    
    Opal.defn(self, '$draw_tile2', TMP_Board_draw_tile2_4 = function $$draw_tile2(left, top, width, height, fill_style, line_width, stroke_style) {
      var self = this;
      ...
      self.$context().strokeStyle = stroke_style;
      return self.$context().stroke();
    }, TMP_Board_draw_tile2_4.$$arity = 7);
    
    Opal.defn(self, '$fill_cell', TMP_Board_fill_cell_5 = function $$fill_cell(x, y) {
      var self = this;

      
      x = $rb_times(x, Opal.const_get_relative($nesting, 'CELL_WIDTH'));
      y = $rb_times(y, Opal.const_get_relative($nesting, 'CELL_HEIGHT'));
      self.$context().fillStyle = "#000";
      return self.$context().fillRect($rb_plus(x.$floor(), 1), $rb_plus(y.$floor(), 1), $rb_minus(Opal.const_get_relative($nesting, 'CELL_WIDTH'), 1), $rb_minus(Opal.const_get_relative($nesting, 'CELL_HEIGHT'), 1));
    }, TMP_Board_fill_cell_5.$$arity = 2);
    
    Opal.defn(self, '$unfill_cell', TMP_Board_unfill_cell_6 = function $$unfill_cell(x, y) {
      var self = this;

      
      x = $rb_times(x, Opal.const_get_relative($nesting, 'CELL_WIDTH'));
      y = $rb_times(y, Opal.const_get_relative($nesting, 'CELL_HEIGHT'));
      return self.$context().clearRect($rb_plus(x.$floor(), 1), $rb_plus(y.$floor(), 1), $rb_minus(Opal.const_get_relative($nesting, 'CELL_WIDTH'), 1), $rb_minus(Opal.const_get_relative($nesting, 'CELL_HEIGHT'), 1));
    }, TMP_Board_unfill_cell_6.$$arity = 2);
    
    Opal.defn(self, '$canvas_id', TMP_Board_canvas_id_7 = function $$canvas_id() {
      var self = this;

      return "board"
    }, TMP_Board_canvas_id_7.$$arity = 0);
    
    Opal.defn(self, '$add_mouse_event_listener', TMP_Board_add_mouse_event_listener_10 = function $$add_mouse_event_listener() {
      var TMP_8, TMP_9, self = this;

      
      $send(Opal.const_get_relative($nesting, 'Element').$find("" + "#" + (self.$canvas_id())), 'on', ["click"], (TMP_8 = function(event){var self = TMP_8.$$s || this, $a, coords = nil, x = nil, y = nil;
if (event == null) event = nil;
      
        coords = self.$get_cursor_position(event);
        $a = [coords.$x(), coords.$y()], (x = $a[0]), (y = $a[1]), $a;
        self.$fill_cell(x, y);
        return self.$seed()['$<<']([x, y]);}, TMP_8.$$s = self, TMP_8.$$arity = 1, TMP_8));
      return $send(Opal.const_get_relative($nesting, 'Element').$find("" + "#" + (self.$canvas_id())), 'on', ["dblclick"], (TMP_9 = function(event){var self = TMP_9.$$s || this, $a, coords = nil, x = nil, y = nil;
if (event == null) event = nil;
      
        coords = self.$get_cursor_position(event);
        $a = [coords.$x(), coords.$y()], (x = $a[0]), (y = $a[1]), $a;
        self.$unfill_cell(x, y);
        return self.$seed().$delete([x, y]);}, TMP_9.$$s = self, TMP_9.$$arity = 1, TMP_9));
    }, TMP_Board_add_mouse_event_listener_10.$$arity = 0);
    
    Opal.defn(self, '$draw_grid', TMP_Board_draw_grid_11 = function $$draw_grid() {
      ...
      self.$context().strokeStyle = "#eee";
      return self.$context().stroke();
    }, TMP_Board_draw_grid_11.$$arity = 0);
    
    Opal.defn(self, '$blank_state', TMP_Board_blank_state_14 = function $$blank_state() {
      var TMP_12, self = this, h = nil;

      
      h = $hash2([], {});
      $send(Opal.Range.$new(0, self.$max_x(), false), 'each', [], (TMP_12 = function(x){var self = TMP_12.$$s || this, TMP_13;
if (x == null) x = nil;
      return $send(Opal.Range.$new(0, self.$max_y(), false), 'each', [], (TMP_13 = function(y){var self = TMP_13.$$s || this, $writer = nil;
if (y == null) y = nil;
        
          $writer = [[x, y], 0];
          $send(h, '[]=', Opal.to_a($writer));
          return $writer[$rb_minus($writer["length"], 1)];}, TMP_13.$$s = self, TMP_13.$$arity = 1, TMP_13))}, TMP_12.$$s = self, TMP_12.$$arity = 1, TMP_12));
      return h;
    }, TMP_Board_blank_state_14.$$arity = 0);
    
    Opal.defn(self, '$redraw_grid', TMP_Board_redraw_grid_16 = function $$redraw_grid() {
      var TMP_15, self = this;

      
      self.$draw_grid();
      return $send(self.$state(), 'each', [], (TMP_15 = function(cell, liveness){var self = TMP_15.$$s || this;
if (cell == null) cell = nil;if (liveness == null) liveness = nil;
      if (liveness['$=='](1)) {
          return self.$fill_cell(cell['$[]'](0), cell['$[]'](1))
          } else {
          return nil
        }}, TMP_15.$$s = self, TMP_15.$$arity = 2, TMP_15));
    }, TMP_Board_redraw_grid_16.$$arity = 0);
    
    Opal.defn(self, '$get_cursor_position', TMP_Board_get_cursor_position_17 = function $$get_cursor_position(event) {
      var $a, self = this, x = nil, y = nil, doc = nil;

      
      if ($truthy(($truthy($a = event.$page_x()) ? event.$page_y() : $a))) {
        
        x = event.$page_x();
        y = event.$page_y();
        } else {
        
        doc = Opal.const_get_relative($nesting, 'Opal').$Document()['$[]'](0);
    ...
    }, TMP_Board_get_cursor_position_17.$$arity = 1);
    
    Opal.defn(self, '$add_demo_event_listener', TMP_Board_add_demo_event_listener_20 = function $$add_demo_event_listener() {
      var TMP_18, self = this;

      return $send(Opal.const_get_relative($nesting, 'Document'), 'on', ["keypress"], (TMP_18 = function(event){var self = TMP_18.$$s || this, TMP_19;
if (event == null) event = nil;
      if ($truthy(self['$ctrl_b_pressed?'](event))) {
          return $send([[25, 1], [23, 2], [25, 2], [13, 3], [14, 3], [21, 3], [22, 3], [12, 4], [16, 4], [21, 4], [22, 4], [35, 4], [36, 4], [1, 5], [2, 5], [11, 5], [17, 5], [21, 5], [22, 5], [35, 5], [36, 5], [1, 6], [2, 6], [11, 6], [15, 6], [17, 6], [18, 6], [23, 6], [25, 6], [11, 7], [17, 7], [25, 7], [12, 8], [16, 8], [13, 9], [14, 9]], 'each', [], (TMP_19 = function(x, y){var self = TMP_19.$$s || this;
if (x == null) x = nil;if (y == null) y = nil;
          
            self.$fill_cell(x, y);
            return self.$seed()['$<<']([x, y]);}, TMP_19.$$s = self, TMP_19.$$arity = 2, TMP_19))
          } else {
          return nil
        }}, TMP_18.$$s = self, TMP_18.$$arity = 1, TMP_18))
    }, TMP_Board_add_demo_event_listener_20.$$arity = 0);
    
    Opal.defn(self, '$ctrl_b_pressed?', TMP_Board_ctrl_b_pressed$q_21 = function(event) {
      var $a, self = this;

      return (($a = event.$ctrl_key()['$=='](true)) ? event.$which()['$=='](2) : event.$ctrl_key()['$=='](true))
    }, TMP_Board_ctrl_b_pressed$q_21.$$arity = 1);
    
    Opal.defn(self, '$add_enter_event_listener', TMP_Board_add_enter_event_listener_24 = function $$add_enter_event_listener() {
      var TMP_22, self = this;

      return $send(Opal.const_get_relative($nesting, 'Document'), 'on', ["keypress"], (TMP_22 = function(event){var self = TMP_22.$$s || this, TMP_23;
if (event == null) event = nil;
      
        $send(self.$seed(), 'each', [], (TMP_23 = function(x, y){var self = TMP_23.$$s || this, $writer = nil;
if (x == null) x = nil;if (y == null) y = nil;
        
          $writer = [[x, y], 1];
          $send(self.$state(), '[]=', Opal.to_a($writer));
          return $writer[$rb_minus($writer["length"], 1)];}, TMP_23.$$s = self, TMP_23.$$arity = 2, TMP_23));
        if ($truthy(self['$enter_pressed?'](event))) {
          return self.$run()
          } else {
          return nil
        };}, TMP_22.$$s = self, TMP_22.$$arity = 1, TMP_22))
    }, TMP_Board_add_enter_event_listener_24.$$arity = 0);
    
    Opal.defn(self, '$enter_pressed?', TMP_Board_enter_pressed$q_25 = function(event) {
      var self = this;

      return event.$which()['$=='](13)
    }, TMP_Board_enter_pressed$q_25.$$arity = 1);
    
    Opal.defn(self, '$run', TMP_Board_run_27 = function $$run() {
      var TMP_26, self = this;

      return $send(Opal.const_get_relative($nesting, 'Interval'), 'new', [], (TMP_26 = function(){var self = TMP_26.$$s || this;

      return self.$tick()}, TMP_26.$$s = self, TMP_26.$$arity = 0, TMP_26))
    }, TMP_Board_run_27.$$arity = 0);
    
    Opal.defn(self, '$tick', TMP_Board_tick_28 = function $$tick() {
      var self = this, $writer = nil;

      
      $writer = [self.$new_state()];
      $send(self, 'state=', Opal.to_a($writer));
      return $writer[$rb_minus($writer["length"], 1)];
    }, TMP_Board_tick_28.$$arity = 0);
    
    Opal.defn(self, '$new_state', TMP_Board_new_state_30 = function $$new_state() {
      var TMP_29, self = this, new_state = nil;

      
      new_state = Opal.const_get_relative($nesting, 'Hash').$new();
      $send(self.$state(), 'each', [], (TMP_29 = function(cell, _){var self = TMP_29.$$s || this, $writer = nil;
if (cell == null) cell = nil;if (_ == null) _ = nil;
      
        $writer = [cell, self.$get_state_at(cell['$[]'](0), cell['$[]'](1))];
        $send(new_state, '[]=', Opal.to_a($writer));
        return $writer[$rb_minus($writer["length"], 1)];}, TMP_29.$$s = self, TMP_29.$$arity = 2, TMP_29));
      return new_state;
    }, TMP_Board_new_state_30.$$arity = 0);
    
    Opal.defn(self, '$get_state_at', TMP_Board_get_state_at_31 = function $$get_state_at(x, y) {
      var self = this;
    ...
    }, TMP_Board_get_state_at_31.$$arity = 2);
    
    Opal.defn(self, '$is_underpopulated?', TMP_Board_is_underpopulated$q_32 = function(x, y) {
      var $a, self = this;

      return ($truthy($a = self['$is_alive?'](x, y)) ? $rb_lt(self.$population_at(x, y), 2) : $a)
    }, TMP_Board_is_underpopulated$q_32.$$arity = 2);
    
    Opal.defn(self, '$is_living_happily?', TMP_Board_is_living_happily$q_33 = function(x, y) {
      var $a, self = this;

      return ($truthy($a = self['$is_alive?'](x, y)) ? [2, 3]['$include?'](self.$population_at(x, y)) : $a)
    }, TMP_Board_is_living_happily$q_33.$$arity = 2);
    
    Opal.defn(self, '$is_overpopulated?', TMP_Board_is_overpopulated$q_34 = function(x, y) {
      var $a, self = this;

      return ($truthy($a = self['$is_alive?'](x, y)) ? $rb_gt(self.$population_at(x, y), 3) : $a)
    }, TMP_Board_is_overpopulated$q_34.$$arity = 2);
    
    Opal.defn(self, '$can_reproduce?', TMP_Board_can_reproduce$q_35 = function(x, y) {
      var $a, self = this;

      return ($truthy($a = self['$is_dead?'](x, y)) ? self.$population_at(x, y)['$=='](3) : $a)
    }, TMP_Board_can_reproduce$q_35.$$arity = 2);
    
    Opal.defn(self, '$population_at', TMP_Board_population_at_36 = function $$population_at(x, y) {
      var self = this;
    ...
    }, TMP_Board_population_at_36.$$arity = 2);
    
    Opal.defn(self, '$is_alive?', TMP_Board_is_alive$q_37 = function(x, y) {
      var self = this;

      return self.$state()['$[]']([x, y])['$=='](1)
    }, TMP_Board_is_alive$q_37.$$arity = 2);
    return (Opal.defn(self, '$is_dead?', TMP_Board_is_dead$q_38 = function(x, y) {
      var self = this;

      return self['$is_alive?'](x, y)['$!']()
    }, TMP_Board_is_dead$q_38.$$arity = 2), nil) && 'is_dead?';
  })($nesting[0], null, $nesting);
  (function($base, $super, $parent_nesting) {
    ...
    return nil
  })($nesting[0], Opal.const_get_relative($nesting, 'OpenStruct'), $nesting);
  board = Opal.const_get_relative($nesting, 'Board').$new();
  tile = Opal.const_get_relative($nesting, 'Tile').$new(1, 1);
  canvas = Opal.const_get_relative($nesting, 'Canvas').$new("board");
  return canvas.$draw_rectangle(50, 50, 100, 100, "blue", 1, "black");
})(Opal);
