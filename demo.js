...
/* Generated by Opal 0.11.4 */
(function(Opal) {
  var self = Opal.top, $nesting = [], nil = Opal.nil, $breaker = Opal.breaker, $slice = Opal.slice, $gvars = Opal.gvars, canvas = nil;
  if ($gvars.global == null) $gvars.global = nil;
  if ($gvars.gvars == null) $gvars.gvars = nil;

  Opal.add_stubs(['$require', '$puts', '$p', '$new', '$draw_rectangle']);
  
  self.$require("opal");
  self.$require("opal-jquery");
  self.$require("demo"+ '/../' + "canvas");
  self.$puts("$global $gvars");
  self.$p($gvars.global);
  self.$p($gvars.gvars);
